...
export type EdgeHelpers = {
  ...
  /**
   * a {@link CoreOptions.isGraphDirected | options.isGraphDirected} aware predicate returning `true` if provided {@link CoreEdge | edge} directs into provided {@link CoreNode | node}
   */
  ...
  /**
   * a {@link CoreOptions.isGraphDirected | options.isGraphDirected} aware predicate returning `true` if provided {@link CoreEdge | edge} directs from provided {@link CoreNode | node} to any other {@link CoreNode | node}
   */
...
export type NodeHelpers = {
  /**
   * a {@link CoreOptions.isGraphDirected | options.isGraphDirected} aware getter for all parents of the provided {@link CoreNode | node}
   *
  ...
  /**
   * a {@link CoreOptions.isGraphDirected | options.isGraphDirected} aware getter for all children of the provided {@link CoreNode | node}
   *
  ...
  /**
   * a {@link CoreOptions.isGraphDirected | options.isGraphDirected} aware getter for all ancestors of the provided {@link CoreNode | node}
   *
  ...
  /**
   * a {@link CoreOptions.isGraphDirected | options.isGraphDirected} aware getter for all descendants of the provided {@link CoreNode | node}
   *
   ...
   *
   * ⚠️ not {@link CoreOptions.isGraphDirected | options.isGraphDirected} aware
   */
  getConnectedEdges: (nodeId: CoreNode['id']) => CoreEdge[];
  /**
   * a {@link CoreOptions.isGraphDirected | options.isGraphDirected} aware getter returning all {@link CoreEdge | edges} connecting into provided {@link CoreNode | node}
   */
  getInboundEdges: (nodeId: CoreNode['id']) => CoreEdge[];
  /**
   * a {@link CoreOptions.isGraphDirected | options.isGraphDirected} aware getter returning all {@link CoreEdge | edges} provided {@link CoreNode | node} connects to
   */
  ...
  /**
   * a {@link CoreOptions.isGraphDirected | options.isGraphDirected} aware getter that returns the edge linking a source node to a target node
   *
